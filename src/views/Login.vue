<template>
  <v-container fill-height fluid text-center>
    <v-container>
      <v-row>
        <v-col
          ...
          sm="4"
          offset="4"
          ><h1 class="h1" >Acesse a sua conta</h1></v-col
        >
      </v-row>
      <v-row class="elavation-3 mx-auto">
        ...
        <v-col>
          <v-form>
            ...
            <v-row>
                <v-col>
                    <v-btn color="indigo lighten-3" @click="login">Login</v-btn>
                    <v-btn class="ml-2" color="indigo lighten-5" @click="reset">Cancelar</v-btn>
                </v-col>
            </v-row>
            <v-row>
                <v-col>
    ...
    <v-snackbar color="indigo lighten-2" v-model="errorLogin" danger multline timeout="2000">
